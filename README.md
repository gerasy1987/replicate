...
```
    ...
    1 intercept   85.013     1.045 85.013 [1.045]   0.000
...
```
    ...
    column_3 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.215     1.109 -0.215 [1.109]   1.152
    ...
    column_1_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.324     1.191  0.324 [1.191]   0.787
    ...
    column_3_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.676     1.527  0.676 [1.527]   0.661
