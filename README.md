...
```
    ...
    column_1 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.368     0.879 -0.368 [0.879]   1.322
    ...
    column_2 
           ...
           term estimate std.error       printout p.value
    1 intercept    0.711     0.668  0.711 [0.668]   0.293
    ...
    column_3 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.215     1.123 -0.215 [1.123]   1.151
    ...
    column_3_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.676     1.461  0.676 [1.461]   0.646
