...
```
    ...
    column_2 
           ...
           term estimate std.error       printout p.value
    1 intercept    0.711     0.670  0.711 [0.670]   0.295
    ...
    column_3 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.215     1.157 -0.215 [1.157]   1.146
    ...
    column_1_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.324     1.190  0.324 [1.190]   0.787
    ...
    column_3_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.676     1.514  0.676 [1.514]   0.658
