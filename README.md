...
```
    ...
    1 intercept   85.013     1.001 85.013 [1.001]   0.000
    ...
    column_2 
           ...
           term estimate std.error       printout p.value
    1 intercept   84.937     0.671 84.937 [0.671]   0.000
...
```
    ...
    column_1 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.368     0.843 -0.368 [0.843]   1.335
    ...
    column_3 
              ...
              term estimate std.error       printout p.value
    1    intercept   -0.215     1.122 -0.215 [1.122]   1.151
    ...
    column_1_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.324     1.239  0.324 [1.239]   0.795
    ...
    column_3_rep 
              ...
              term estimate std.error       printout p.value
    1    intercept    0.676     1.488  0.676 [1.488]   0.652
